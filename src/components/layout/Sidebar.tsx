...
import {
  ...
  FileText, Users, History, Settings, Building2, Truck, Inbox, DollarSign
} from 'lucide-react'
...
const staffNav = [
  ...
  { href: '/email-transactions',  label: 'Email Transactions', icon: Inbox },
  { href: '/charges',             label: 'Charges',            icon: DollarSign },
  { href: '/consignees',          label: 'Consignees',         icon: Building2 },
  { href: '/carriers',            label: 'Carriers',          icon: Truck },
  { href: '/documents',           label: 'Documents',         icon: FileText },
  ...
  return (
    <aside className="w-60 min-h-screen bg-white border-r border-gray-200 flex flex-col shadow-lg md:shadow-none">
      ...
      <div className="px-5 py-4 border-b border-gray-200">
        <span className="text-lg font-semibold text-blue-700 tracking-tight">{process.env.NEXT_PUBLIC_SITE_NAME ?? 'CTS Portal'}</span>
      </div>
